...
#################################################################################
#
# Questao02.sh - Operação valores
#
# Autor: Gabriel Silva (gabrielsilvaaires62@gmail.com)
# Data de criação: 08/08/2023
#
# Descrição: O script recebe dois valores inseridos pelo usuário e exibe 
# um menu para que uma das operações básicas seja realizada.
#
...
case $OPCAO in
  ...
  3)
    ...
    then
      echo "Um 0 não pode ser utilizado em uma multiplicação"
      exit 1
    fi
    OPER="*"
    ;;
